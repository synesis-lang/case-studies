[paths]
#
# bib_file: Defines the name of Better Bibtex file, and it's folder. It contains the abstracts to be processed.
# csv_file: Defines the name of CSV file, and it's folder. It will contains reference and abstract columns.
#
bib_file = "input/mais_citados.bib"
csv_file = "input/mais_citados_novo_prompt.csv"

[abstract_processor]
#
# Claude private API key.
# concurrent: Number of concurrent requests allowed.
# retries: Number of retries for failed API calls.
# batch_size: Number of abstracts per processing batch.
# input_file: Default 'csv' input file name, with abstracts.
# output_file: Default 'txt' output file name.
#
# AI_model = "claude-opus-4-20250514"
AI_model = "claude-sonnet-4-5-20250929"
api_key = "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"
concurrent = 5  # Tier 1 minimum 
retries = 5
batch_size = 25  # Reduce cooldown cycles
input_file = "new_full_process/bibliometrics_all_453.bib"
output_file = "new_full_process/bibliometrics_all_453.txt"
log_file = "new_full_process/bibliometrics_all_453.log"
...
retries = 5
batch_size = 20
input_file = "new_full_process/bibliometrics_all_453_memory.json"
output_file = "new_full_process/bibliometrics_all_453_topics.csv"
log_file = "new_full_process/bibliometrics_all_453_topics.log"
